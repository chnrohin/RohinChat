...
public class HeaderRecyclerView extends RecyclerView {
    ...
    public interface DividerItemDecoration {
    ...
    /**
     * An adapter that can optionally add one header fill to the RecyclerView.
     *
    ...
    private void init(AttributeSet attrs, int defStyleAttr) {
        final TypedArray a = getContext().obtainStyledAttributes(attrs,
                R.styleable.HeaderRecyclerView, defStyleAttr, 0);
        mHeaderRes = a.getResourceId(R.styleable.HeaderRecyclerView_suwHeader, 0);
        a.recycle();
    }
    ...
    public void onInitializeAccessibilityEvent(AccessibilityEvent event) {
        ...
        // Decoration-only headers should not count as an fill for accessibility, adjust the
    ...
    public void setLayoutManager(LayoutManager layout) {
        ...
        if (layout != null && mHeader == null && mHeaderRes != 0) {
            ...
            // any header fill is specified in XML and inflate them.
