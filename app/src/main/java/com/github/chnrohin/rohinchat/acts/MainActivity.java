...
import com.github.chnrohin.rohinchat.frgms.MeFragment;
import com.github.chnrohin.rohinchat.frgms.ServiceFragment;
import com.github.chnrohin.rohinchat.acts.social.ContactsDetailActivity;
import com.github.chnrohin.rohinchat.acts.social.AddContactsActivity;
import com.github.chnrohin.rohinchat.data.entity.Contacts;
import com.github.chnrohin.rohinchat.data.entity.SimpleChat;
import com.github.chnrohin.rohinchat.acts.chat.ChatWithActivity;
import com.github.chnrohin.rohinchat.acts.search.SearchActivity;
import com.github.chnrohin.rohinchat.common.design.viewpage.transformer.ZoomOutPageTransformer;

/**
 * @author Rohin
 * @date 2018/7/15
 */
public class MainActivity extends BaseToolbarActivity implements ChatFragment.OnSimpleChatItemClickListener
    ...
    /**
     * 滑动切换fragment后，BottomNavigationView设置相应项的状态
     */
    ...
    private void initNavigation() {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M){
            ...
            // logoColor
            checkedColor = Constants.LOGO_COLOR;
        }
        int[][] states = new int[][]{
        ...
        if (requestCode == CHAT_WITH_REQUEST_CODE) {
            if (resultCode == RESULT_OK) {
                Snackbar.make(mToolbar, data.getIntExtra(ChatWithActivity.EXCEPTION_NPE_CONTACTS
                        ...
                        .setAction(R.string.close, (v -> { /* TODO */})).show();
            }
        }
    }
